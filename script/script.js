...
const infoCats = [
    ...
    {
        type: "Гладкошерстная",
        color: "Трёхцветная с зелёными глазами",
    ...
    {
        type: "Гладкошерстная",
        color: "Черно-белая с зелёными глазами",
        vaccine: "Вакцинирована",
        passport: "Есть ветпаспорт",
        things: "Приучена к когтеточке",
        tray: "Знает лоточек"
    ...
    {
        type: "Гладкошерстная",
        color: "Трехцветная с зелёными глазами",
        vaccine: "Вакцинирована",
        passport: "Есть ветпаспорт",
        things: "Приучена к когтеточке",
        tray: "Знает лоточек"
...
for (let i = 0; i < infoCats.length; i++) {
    ...
    targetElement.insertAdjacentHTML('afterbegin', infoList);
}
